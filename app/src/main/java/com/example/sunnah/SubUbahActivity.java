...
public class SubUbahActivity extends AppCompatActivity {
    private int xId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sub_ubah);
        ...
        tampilData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                ...
                for (DataModel data : listData) {
                    if (data.getSub().equals(xSubKategori)) { // Sesuaikan dengan representasi yang tepat
                        filteredList.add(data);
                    }
                }

                adData = new AdapterDataSunnah(SubUbahActivity.this, filteredList);
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                Toast.makeText(SubUbahActivity.this, "Gagal Menghubungi Server : "+t.getMessage(), Toast.LENGTH_SHORT).show();
