...
public class SunnahDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sunnah_data);
    ...
    public void retrieveData(){
        ...
        tampilData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                ...
                adData = new AdapterDataSunnah(SunnahDataActivity.this, filteredList);
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                Toast.makeText(SunnahDataActivity.this, "Gagal Menghubungi Server : "+t.getMessage(), Toast.LENGTH_SHORT).show();
